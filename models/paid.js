...
const Paid_Schema = new mongoose.Schema({
  name: {
    type: String,
    required: true
  },
...
Paid_Schema.pre('save', async function (next) {
...
Paid_Schema.methods.matchPassword = async function (pwd) {
...
Paid_Schema.methods.genAuthToken = async function () {
  try {
...
module.exports = mongoose.model('Paid', Paid_Schema);
